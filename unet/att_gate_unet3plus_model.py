...
class UNet3plusAttention(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False):
        super(UNet3plusAttention, self).__init__()
        ...
        self.attd4 = (AttentionBlock(self.cat_channels, self.cat_channels*4, self.cat_channels*4//2))
        ...
        self.attd3 = (AttentionBlock(self.cat_channels, self.cat_channels*4, self.cat_channels*4//2))
        ...
        self.attd2 = (AttentionBlock(self.cat_channels, self.cat_channels*4, self.cat_channels*4//2))
        ...
        self.attd1 = (AttentionBlock(self.cat_channels, self.cat_channels*4, self.cat_channels*4//2))
    ...
    def forward(self, x):
        ...
        en5d4 = self.en5d4(d5)
        attd4 = self.attd4(en5d4, torch.cat((en1d4, en2d4, en3d4, en4d4), 1))
        d4 = self.catd4(torch.cat((en5d4, attd4), 1))
        ...
        en4d3 = self.en4d3(d4)
        en5d3 = self.en5d3(d5)
        attd3 = self.attd3(en4d3, torch.cat((en1d3, en2d3, en3d3, en5d3), 1))
        d3 = self.catd3(torch.cat((en4d3, attd3), 1))
        ...
        en4d2 = self.en4d2(d4)
        en5d2 = self.en5d2(d5)
        attd2 = self.attd2(en3d2, torch.cat((en1d2, en2d2, en4d2, en5d2), 1))
        d2 = self.catd2(torch.cat((en3d2, attd2), 1))
        ...
        en4d1 = self.en4d1(d4)
        en5d1 = self.en5d1(d5)
        attd1 = self.attd1(en2d1, torch.cat((en1d1, en3d1, en4d1, en5d1), 1))
        d1 = self.catd1(torch.cat((en2d1, attd1), 1))
